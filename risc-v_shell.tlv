...
\TLV
   ...
   // Extract fields
   `BOGUS_USE($rd $rd_valid $rs1 $rs1_valid $rs2 $rs2_valid $opcode
   ...
   $is_lui = $dec_bits ==? 11'b_x_xxx_0110111;
   $is_auipc = $dec_bits ==? 11'b_x_xxx_0010111;
   $is_jal = $dec_bits ==? 11'b_x_xxx_1101111;
   $is_jalr = $dec_bits ==? 11'b_x_000_1100111;
   ...
   *failed = *cyc_cnt > M4_MAX_CYC;
   ...
   m4+rf(32, 32, $reset, $rd_valid, $rd, $dest_data, $rs1_valid, $rs1, $src1_value, $rs2_valid, $rs2, $src2_value)
